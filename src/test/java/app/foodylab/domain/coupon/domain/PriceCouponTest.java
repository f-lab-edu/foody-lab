...
class PriceCouponTest {
    ...
    void test2() {
        assertDoesNotThrow(() -> Coupon.of(10000L));
    }
    ...
    void test3() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
            () -> Coupon.of(10000L, LocalDate.now().minusDays(1),
    ...
    void test4() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
            () -> Coupon.of(10000L, LocalDate.now(), LocalDate.now().minusDays(1)));
    ...
    void test5() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
            () -> Coupon.of(10000L, LocalDate.now().plusDays(2), LocalDate.now().plusDays(1)));
