...
class PriceCouponTest {
    ...
    void test3() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
            () -> PriceCoupon.of(10000, LocalDate.now().minusDays(1),
    ...
    void test4() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
            () -> PriceCoupon.of(10000, LocalDate.now(), LocalDate.now().minusDays(1)));
    ...
    void test5() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class,
            () -> PriceCoupon.of(10000, LocalDate.now().plusDays(2), LocalDate.now().plusDays(1)));
